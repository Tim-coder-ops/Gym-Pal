...
namespace GymPal.Controllers
{
    public class WorkoutsController : Controller
    {
        ...
        public WorkoutsController(GymPalDbContext context)
        {
            _context = context;
        }
        ...
        {
            var gymPalDbContext = _context.Workout.Include(w => w.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,WorkoutNumber,UserId,Date")] Workout workout)
        {
